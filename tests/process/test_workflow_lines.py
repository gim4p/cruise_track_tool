...
class TestLineWorkflow(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.params1 = pickle.load(open('/home/markus/scripting/cruise_track_tool/tests/data/line_layer_as_df.pickle', "rb"))
...
class TestLineWorkflowIndividualLines(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.params2 = pickle.load(open('/home/markus/scripting/cruise_track_tool/tests/data'
